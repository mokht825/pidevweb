 ...
 */
final class Version20210424140714 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE coach ADD typesesport_id INT DEFAULT NULL, ADD disponibilite VARCHAR(255) NOT NULL, DROP Disponabilite, DROP Typesesport');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD CONSTRAINT evenement_ibfk_1 FOREIGN KEY (Idcoach) REFERENCES coach (Idcoach)');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT reservation_ibfk_1 FOREIGN KEY (Idcoach) REFERENCES coach (Idcoach)');
        $this->addSql('DROP TABLE diplome');
        $this->addSql('DROP INDEX IDX_3F596DCCD800119A ON coach');
        $this->addSql('ALTER TABLE coach ADD Typesesport VARCHAR(255) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, DROP typesesport_id, CHANGE disponibilite Disponabilite VARCHAR(255) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`');
    }
}
