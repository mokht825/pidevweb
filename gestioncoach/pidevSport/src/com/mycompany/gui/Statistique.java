...
public class Statistique extends BaseForm {
        ...
        ServiceCoach es = new ServiceCoach();
        double li = ServiceCoach.getInstance().getNbrCoach();
        
      
        double totalDiplome  = ServiceDiplome.getInstance().getNbrDiplome();
...
BaseForm form;
        ...
        addTab(swipe, res.getImage("coach.jpg"), spacer1, "Bienvenue a notres statistuqes");
        ...
        RadioButton all = RadioButton.createToggle("Coach", barGroup);
       
        all.setUIID("SelectBar");
        RadioButton popular = RadioButton.createToggle("", barGroup);
        popular.setUIID("SelectBar");
        RadioButton feedback = RadioButton.createToggle("Coach", barGroup);
        feedback.setUIID("SelectBar");
        RadioButton profile = RadioButton.createToggle("Diplome", barGroup);
...
createPieChartForm();
   ...
   private void addButton(Image img,String title, Coach  evv) {
  ...
  ;       
       ...
       image.addActionListener(e -> {
           try{
           new AjoutCoachForm(Resources.getGlobalResources()).show();
           }catch(Exception exx) {
...
//        for (double value : values) {           
            series.add("Coach " , valuesRec);
            series.add("Diplomes" , valuesFeed);
//        }
        return series;
    }
    ...
    public void createPieChartForm() {
        ...
        double total  = li + totalDiplome;
        
        // Generate the values
        //float pourcentage = (li*100)/li.get(1);
            double pourcentage = (li*100)/total;
                        double pourcentage1 = (totalDiplome*100)/total;
